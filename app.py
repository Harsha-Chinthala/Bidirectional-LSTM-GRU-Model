...
def ask_question():
    ...
    try:
        ...
        answers = {
            ...
            "model accuracy": "The model achieved an accuracy of 90.03% on the test dataset.",
            "precision": "The model's precision score is 0.92, meaning it correctly identifies positive reviews 82% of the time.",
            "recall": "The recall score is 0.80, which means the model captures 91.58% of all actual positive reviews.",
            "f1 score": "The F1 score of the model is 92.21%, providing a balance between precision and recall.",
            "What are the evalution metrics used": "The model was evaluated using accuracy, precision, recall, and F1 score. The model performs well with an accuracy of 85%.",
            ...
            "performance evaluation": "The model's performance was evaluated using a test set of 10,00,000 Amazon reviews, and the accuracy reached 90%.",
        }
        ...
        question_variants = {
            ...
            "What are the evalution metrics used":["What are the evalution metrics used","evalution metrics"],
